...
//                          CTargetPlanet
//
// HISTORY:             2016-03-25 GGB - Development of classes for AIRDAS
//
//*********************************************************************************************************************************

#include "../Include/TargetPlanet.h"

namespace ACL
{
  CTargetPlanet::CTargetPlanet(EPlanets const &np) : CTargetSolar(""), planet(np)
  {
