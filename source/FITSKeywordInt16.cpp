...
namespace ACL
{
  ...
  CFITSKeywordInt16::CFITSKeywordInt16(CFITSKeywordInt16 const &toCopy) : CFITSKeyword(toCopy.keyword_, toCopy.comment_)
  {
    (*this) = toCopy;
  }
  ...
  CFITSKeywordInt16 &CFITSKeywordInt16::operator=(CFITSKeywordInt16  const &rhs)
  {
  ...
  CFITSKeywordInt16::operator std::int8_t() const
  {
  ...
  CFITSKeywordInt16::operator std::int16_t() const
  {
    return value_;
  }

  CFITSKeywordInt16::operator std::int32_t() const
  {
    return (static_cast<std::int32_t>(value_));
  }

  CFITSKeywordInt16::operator std::int64_t() const
  {
    return (static_cast<std::int64_t>(value_));
  }

  CFITSKeywordInt16::operator std::uint8_t() const
  {
  ...
  CFITSKeywordInt16::operator std::uint16_t() const
  {
  ...
  CFITSKeywordInt16::operator std::uint32_t() const
  {
    return (static_cast<std::uint32_t>(value_));
  }

  CFITSKeywordInt16::operator float() const
  {
    return (static_cast<float>(value_));
  }

  CFITSKeywordInt16::operator double() const
  {
    return (static_cast<double>(value_));
  }

  CFITSKeywordInt16::operator std::string() const
  {
  ...
  KWType CFITSKeywordInt16::type() const
  {
    return KWT_INT16;
  }
  ...
  void CFITSKeywordInt16::writeToFITS(fitsfile *file) const
  {
    CFITSIO_TEST(fits_update_key, file, TSHORT, keyword_.c_str(), const_cast<void *>(static_cast<void const *>(&value_)),
                                 comment_.c_str());
  }
