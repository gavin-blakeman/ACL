...
namespace ACL
{
  ...
  void CLoader::loadErrorMessages()
  {
    std::vector<std::pair<GCL::TErrorCode, std::string>> errors =
    {
      ...
      {0x0302, "AstroFunctions: Keplers equation failed to converge."},
      ...
      {0x2700, "TargetMinorPlanet: Minor Planet Specified not found"},
      ...
      {0x3300, "TargetMinorPlanet: Unable to open MPCORB.DAT"},
