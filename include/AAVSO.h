...
#define MAX_OBSCODE					5
#define MAX_SOFTWARE				30
#define MAX_OBSTYPE					5
#define MAX_NAME						30
#define MAX_DATE						30
#define MAX_FILTERSTRING		5
#define MAX_NOTES						100
  ...
  extern char szFilters[25][MAX_FILTERSTRING+1];

  class CAAVSOExtendedFormat
  {
  private:
    char szObsCode[MAX_OBSCODE+1];
    char szSoftware[MAX_SOFTWARE+1];
    char cDelim;
    AAVSODate DateType;
    char szObsType[MAX_OBSTYPE+1];
  ...
  private:
    ...
    char szDate[MAX_DATE+1];
    FP_t fMagnitude;
    FP_t fMagError;
    char szFilter[MAX_FILTERSTRING+1];
    bool bTransformed;
    char szMype[4];
    char szCName[MAX_NAME+1];
    FP_t fCMag;
    char szKName[MAX_NAME+1];
    FP_t fKMag;
    FP_t fAirmass;
    int nGroup;
    char szChart[6+1];
    char szNotes[MAX_NOTES+1];
